...
{/* --- KÖZÖS SÖTÉT WRAPPER (CTA + ROSE + LÁBLÉC) --- */}
      <div className="w-full bg-[#0B131A] text-white flex flex-col">
        ...
        {/* --- CTA / KAPCSOLAT ÉS ASZTALFOGLALÁS (Letisztult, szilárd háttérrel) --- */}
        ...
        {/* --- ROSE MEZE (Moziszerű képes banner, egybeolvadó átmenetekkel) --- */}
        <section className="relative z-10 py-24 lg:py-32 overflow-hidden">
          <div className="absolute inset-0 z-0">
            ...
            {/* Ez az átmenet felel azért, hogy fent és lent észrevétlenül olvadjon bele a #0B131A háttérbe */}
